...
const dseCompanies = {
  ...
  MCB: { name: 'Mwanga Hakika Microfinance Bank Plc', sector: 'Banking' },
  MANICA: { name: 'Manica Freight Services (T) Ltd', sector: 'Logistics' },
  TBL: { name: 'Tanzania Breweries Ltd', sector: 'Manufacturing' },
  TCC: { name: 'Tanzania Cigarette Company Ltd', sector: 'Manufacturing' },
  TOL: { name: 'Tanzania Oil & Gas Plc', sector: 'Energy' },
  TTP: { name: 'Tanzania Tea Packers Ltd', sector: 'Agriculture' },
  TCCL: { name: 'Tanzania China Clay Ltd', sector: 'Manufacturing' },
  SWALA: { name: 'Swala Oil & Gas Plc', sector: 'Energy' },
  AFRIPRISE: { name: 'Afriprise Holdings Ltd', sector: 'Financial Services' },
